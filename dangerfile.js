...
if (danger.github && danger.github.pr) {
  ...
  if (modifiedHelp || createdHelp) {
    warn(
      "You've modified files in the `help/` directory.\nWe recommend to make all CLI Help changes in the snyk/user-docs repository in order to sync the changes with Gitbook.\nFor more info, [check out the help readme](https://github.com/snyk/snyk/tree/master/help).",
    );
  }
}
